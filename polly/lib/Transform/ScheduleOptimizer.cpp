...
optimizeDataLayoutMatrMulPattern(isl::schedule_node Node, isl::map MapOldIndVar,
  ...
  //LLVM_DEBUG(dbgs() << "\n\nMap old ind var: " << MapOldIndVar.to_str() << "\n\n");
...
bool IslScheduleOptimizer::runOnScop(Scop &S) {
  ...
  // Print schedule tree with extension nodes
  LLVM_DEBUG({
    dbgs() << "\n\n\n SCHEDULE WITH EXTENSIONS:\n";
    dbgs() << NewSchedule.get_root().to_str() << "\n\n\n";
  });
...
//  LLVM_DEBUG(dbgs() << "Final isl opt schedule:\n");
//  NewSchedule.dump();

  S.setScheduleTree(NewSchedule);
  S.markAsOptimized();
//  LLVM_DEBUG(dbgs() << "new matrix code...\n");
//  printAstForScop(S);
//  LLVM_DEBUG(dbgs() << "\n\n\n\n");
