...
llvm::Pass *createJSONExporterPass(const std::string &c = "");
...
llvm::Pass *createHMScheduleModifierPass();
llvm::Pass *createHMRacetrackScheduleOptimizerPass();
llvm::Pass *createHMRacetrackScheduleSpaceSearcherPass();
llvm::Pass *createHMRacetrackSchedulePatternMatcherPass();
...
struct PollyForcePassLinking {
  PollyForcePassLinking() {
    ...
    polly::createHMScheduleModifierPass();
    polly::createHMRacetrackScheduleOptimizerPass();
    polly::createHMRacetrackScheduleSpaceSearcherPass();
    polly::createHMRacetrackSchedulePatternMatcherPass();
  }
...
void initializeHMScheduleModifierPass(llvm::PassRegistry &);
void initializeHMRacetrackScheduleOptimizerPass(llvm::PassRegistry &);
void initializeHMRacetrackScheduleSpaceSearcherPass(llvm::PassRegistry &);
void initializeHMRacetrackSchedulePatternMatcherPass(llvm::PassRegistry &);
} // namespace llvm
